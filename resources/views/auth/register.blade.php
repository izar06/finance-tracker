...
<head>
    ...
    <title>Daftar — Finance Tracker</title>
    ...
    <style>
        ...
        .error-text { color: #ef4444; font-size: 0.75rem; margin-top: 0.3rem; }
    </style>
</head>
<body class="h-full auth-bg flex items-center justify-center min-h-screen relative overflow-hidden">

    <!-- Floating decorations -->
    <div class="floating-shape w-64 h-64 -top-16 -right-16" style="animation-delay: 0s;"></div>
    <div class="floating-shape w-48 h-48 top-1/3 -left-12" style="animation-delay: 2s;"></div>
    <div class="floating-shape w-32 h-32 bottom-16 right-1/4" style="animation-delay: 4s;"></div>
    <div class="floating-shape w-20 h-20 bottom-1/3 left-1/4" style="animation-delay: 1s;"></div>
    ...
    <div class="w-full max-w-md px-4 py-8 card-enter">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-primary-900">Buat Akun Baru</h1>
            <p class="text-sm text-primary-400 mt-1">Mulai kelola keuanganmu sekarang</p>
        </div>
        ...
        <div class="glass-card rounded-2xl shadow-xl shadow-primary-200/50 p-8">
            ...
            <form method="POST" action="{{ route('register.post') }}" class="space-y-4">
                ...
                <div>
                    <label class="block text-sm font-semibold text-primary-700 mb-1.5">Nama Lengkap</label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-primary-700 mb-1.5">Konfirmasi Password</label>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-slate-500">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="font-semibold text-primary-600 hover:text-primary-800 transition-colors">Masuk di sini</a>
                </p>
            </div>
        </div>
