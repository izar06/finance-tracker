                ...
                <div class="rounded-2xl border <?php echo e($bgLight); ?> shadow-sm p-4 sm:p-5">
                    ...
                    <div class="mb-2.5">
                        <div class="w-full bg-slate-100 rounded-full h-2.5 overflow-hidden">
                            <div class="<?php echo e($barColor); ?> h-2.5 rounded-full transition-all duration-500"
                    ...
                    <div class="mt-1 text-xs text-slate-400">
                        Anggaran: Rp <?php echo e(number_format($budget->amount, 0, ',', '.')); ?>
            ...
            <div class="relative bg-white w-full sm:max-w-md sm:rounded-2xl rounded-t-2xl shadow-xl p-6 z-10
                ...
                <div class="flex items-center justify-between mb-5">
                    <h3 class="font-bold text-slate-800 text-lg">
                        <?php echo e($editingId ? 'Edit Anggaran' : 'Tambah Anggaran'); ?>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editingId && $category): ?>
                                    <option value="<?php echo e($category); ?>" selected><?php echo e($category); ?></option>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH /Users/izarhairulanam/Downloads/finance-tracker-responsive 7/resources/views/livewire/budgets/index.blade.php ENDPATH**/ ?>